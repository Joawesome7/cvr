...
## Overview
A static frontend website built as a client prototype for CVR Inc. It allows potential buyers and renters to browse property listings, view property details, and send inquiries directly to agents - without requiring a backend.
...
- `/pages/listings.html` - Full  listings page with filter and sort
- `/pages/property.html` - Property detail page with photo gallery and inquiry form
